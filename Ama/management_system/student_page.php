...
<div class="d-flex">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="roll" placeholder="Enter Roll No. i.e. 1602071" name="roll">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="session" placeholder="Enter Session i.e. 2016-17" name="session">
