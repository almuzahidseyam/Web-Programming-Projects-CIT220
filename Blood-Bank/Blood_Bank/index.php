    ...
    <div class="container">
      ...
      <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="#">
                    <img class="img-responsive img-portfolio img-thumbnail img-hover" src="images/h1.jpg" alt="">
                </a>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="#">
        ...
        <div class="row">
			...
			<ul>
				...
				<li>We need over 100 blood donations every day to treat patients in need across Bangladesh. Which is why there’s always a need for people to give blood.</li>

				<li>Each year we need approximately 2,000 new donors, as some donors can no longer give blood.</li>

				<li>Most people between the ages of 17-65 are able to give blood.</li>

				<li>Around half our current donors are over 28. That's why we need more young people (over the age of 17) to start giving blood, so we can make sure we have enough blood in the future.</li>
