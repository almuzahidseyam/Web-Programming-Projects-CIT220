...
$email = $name = $password = $confirm_password = $blood_groups  = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($name_err) && empty($password_err) && empty($confirm_password_err) && empty($blood_groups_err)){
        ...
        $sql = "INSERT INTO users (email, name, password, blood_group) VALUES (?, ?, ?, ?)";
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            $stmt->bind_param("ssss", $param_email, $param_name, $param_password, $param_blood_group);
