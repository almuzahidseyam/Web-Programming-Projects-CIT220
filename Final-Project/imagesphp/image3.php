             ...
             <div class="col-xs-12 col-md-4" style="margin-top: 15px; "> 
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">Babies & Toys</h3>
                    </div>
                    <div class="panel-body" >
                        <center>
                    <img src="images/k3.jpg" alt="Babies & toys" style="height:160px;" />
                <div class="caption">
                    ...
                    <a href="Baby.php" name="add" value="add" class="btn btn-primary btn-block" >Browse</a>
                    <?php
                    }}
                    ?>
                </div>
