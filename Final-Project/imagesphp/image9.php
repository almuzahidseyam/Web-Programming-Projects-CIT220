            ...
            <div class="col-xs-12 col-md-4" style="margin-top: 15px; ">              
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center">Woman's Fashion</h3>
                    </div>
                    <div class="panel-body" >
                        <center>
                    <img src="images/k9.jpg" alt="Woman's" style="height:185px;" />
                <div class="caption">
                    ...
                    <a href="woman.php" name="add" value="add" class="btn btn-primary btn-block" >Browse</a>
                    <?php
                    }}
                    ?>
                </div>
