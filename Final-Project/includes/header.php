...
<div class="navbar navbar navbar-fixed-top" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" style="color: white;" href="index.php">Pstu Store</a>
                </div>
                <div class="collapse navbar-collapse" >
                    <ul class="nav navbar-nav navbar-right">
                        <?php if(!isset($_SESSION['email'])){?>
                            <li  style="font-weight:bold; color: #0d0d0d;font-size:15px;" ><a href="signup.php"><span class="glyphicon glyphicon-admin-panel"></span>Admin Panel</a></li>
                        <li  style="font-weight:bold; color: #0d0d0d;font-size:15px;" ><a href="signup.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
