...
<!-----------------------Side navabr--------------->
              ...
              <div class="container">
                <h2 style="font-family:Lucida console;text-align:center;font-weight:bold;color:white">Add New Books</h2><br>
                <form action="" method="post" class="book" >
                  ...
                  <input type="text" name="author" placeholder="Author Name" class="form-control" required=""><br>
         ...
         <script type="text/javascript">
          alert("Book is Successful added!!");
