...
<!-----------------------Side navabr--------------->
    ...
    <!---________________searchbar____________________---->
                    ...
                    <button type="submit"name="submit" class="btn btn-default" style="background-color:#2bc7b6"><span class="glyphicon glyphicon-search"></span></button>
                      ...
                      <div class="wrapper">
                     <h2 style="font-family:Lucida Console">List of Books</h2>
                      <?php
                    if(isset($_POST['submit'])){
                      ...
                      if( mysqli_num_rows($q)==0){
                      	  ...
                      	  echo "<span style='color:red;font-size:34px;font-wight:bold;font-family:Lucida Console'>Sorry !!!! Book is not found</span>";
                      }
                      else
