    ...
    <div class="container-fluid">
          <div class="page-header row">
           ...
           <img width="auto" height="130" class="img-responsive" 
                    src="../../../PHP_All_Projects/Resturant_Integration/image/res_Banner.jpg" alt="banner">
                    <!--   src er jonno entire file location lage   -->
                    <!--    [ ..\ ] => [ek folder previous kora] &&  [ ../ ] => [ek folder forward kora] -->
                    <!--   include er jonno currentfolder theke bibechona kore [ ..\ ] or  [ ../ ] diye file er imidiate folder -->
                    <!--   href er jonno localfolder(www) theke bibechona kore  [ ../ ] diye file er imidiate folder -->
        </div>
    </div>
            ...
            <nav class="navbar-expand-md navbar-light bg-info">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                   ...
                   <!-- Search
        <form action="include/search.php" method="post" class="form-inline my-2 my-lg-0">
