...
<!--                           breakfast div-->
                         ...
                         <input  type="date"  name="Udate" style="border-color: crimson; color: aqua; background-color: coral; border-radius: 4px">
                          ...
                          <button class="btn btn-outline-success btn-block" type="submit" name="bpost">Order</button>
                </form>
             </div>
                   ...
                   <button class="btn btn-outline-success btn-block" type="submit" name="lpost">Order</button>
               </form>
             </div>
                     ...
                     <button class="btn btn-outline-success btn-block" type="submit" name="dpost">Order</button>
               </form>
             </div>
