...
<table align="center">
<form action="admissiondelete.php" method="post">
...
if(isset($_POST['submit']))
		{
			...
			$class=$_POST['class'];
			$year=$_POST['year'];
			$sql="SELECT * FROM `nstudent` WHERE `class`='$class' AND `year`LIKE '%$year%' ORDER By `marks`DESC";
			...
			if(mysqli_num_rows($run)<1)
			{
				...
				while($data=mysqli_fetch_assoc($run))
				{
					...
					<tr align="center">
						...
						<td><a href="adeleteform.php?sid=<?php echo $data['id'];?>">Delete</a></td>
					</tr>
					<?php
