...
<html lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Students Thesis Result</title>
		<link rel="icon" href="Images/favicon.png" type = "image/png" />
		<link rel="shortcut icon" href="Images/favicon.ico"/>
		<link rel="stylesheet" href="index.inc.css"/>
	</head>
	<body>
		<a href = "a.php" class="link"><div id="admin">
			<p>Login as Admin</p>
			</div><a>
			<a href = "examiner.login.php" class="link"><div id="teacher">
				...
				<div id = "form">
					<form action="index.inc.php" method = "post" name = "login" id = "login" />
